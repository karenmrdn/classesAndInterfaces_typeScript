...
class AccountingDepartment extends Department {
  ...
  // reports created using shorthand: we have no need to specify
  // specific property and assign a value to it in constructor if we
  // provide type and visibility in constructor parameters
